...
namespace InfinityPBR
{
    ...
    public class ColorShifter : EditorWindow
    {
        ...
        private string _shaderNameHDRP = "InfinityPBR/LPColor-HDRP";
        private string _shaderNameURP = "InfinityPBR/LPColor-URP";
...
*/
            ...
            {
                if (GUILayout.Button("Set Unnamed Colors Hidden"))
                {
                    Undo.RecordObject(colorShifterObject, "Hide Unnamed Colors");
                    colorShifterObject.HideUnnamedColors();
                }
            }
        ...
        private void DisplayItemOpen(ColorShifterColorItem colorShifterColorItem, int index)
        {
            ...
            if (colorShifterColorItem.colorItemChildren.Count > 0)
            {
                ...
                for (int c = 0; c < colorShifterColorItem.colorItemChildren.Count; c++)
                {
                    ...
                    EditorGUILayout.BeginHorizontal();
                    EditorGUILayout.LabelField($"{childItem.name}");
